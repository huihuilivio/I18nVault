...
static void gf128_mul(uint8_t out[16],
                      const uint8_t X[16],
                      const uint8_t Y[16]) {
  uint8_t Z[16] = {0};
  uint8_t V[16];
...
static void ghash_full(const uint8_t H[16],
...
static void gctr(const sm4_ctx *cipher,
...
static void compute_j0(const gcm_ctx *ctx,
...
int gcm_encrypt(const gcm_ctx *ctx,
                const uint8_t *iv, size_t iv_len,
                const uint8_t *aad, size_t aad_len,
...
int gcm_decrypt(const gcm_ctx *ctx,
                const uint8_t *iv, size_t iv_len,
                const uint8_t *aad, size_t aad_len,
                const uint8_t *ct, size_t ct_len,
                uint8_t *pt,
